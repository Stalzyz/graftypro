...
const FLOW_NODES = [
    {
        id: 'start', name: 'Start Node', icon: <Play size={18} />, color: 'bg-emerald-500',
    ...
    {
        id: 'message', name: 'Message Node', icon: <MessageSquare size={18} />, color: 'bg-blue-500',
        desc: 'Text & Media',
    ...
    {
        id: 'list', name: 'List Node', icon: <List size={18} />, color: 'bg-fuchsia-500',
        desc: 'Multi-Option Menu',
