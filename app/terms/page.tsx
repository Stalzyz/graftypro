                ...
                <div className="max-w-4xl mx-auto px-6">
                    ...
                    <div className="space-y-16">
                        <TermSection
                            ...
                            content="By accessing or using Grafty (a product of Grekam), you agree to be bound by these Terms and Conditions. Our services are built upon the Meta WhatsApp Cloud API. By using our platform, you also agree to strictly adhere to Meta's WhatsApp Business Terms of Service and WhatsApp Business Messaging Policies."
                        />
                        <TermSection
                        ...
                        <TermSection
                            ...
                            content="Grafty provides technical infrastructure to utilize Meta's Cloud API. You acknowledge that your use of WhatsApp is subject to Meta's approval. Grafty is not responsible for any suspension or termination of your WhatsApp Business Account (WABA) by Meta due to policy violations. You agree not to use the service for spamming, transmitting prohibited content, or any activity that violates Meta's guidelines."
                        />
                        <TermSection
                            title="4. Prohibited Content & Activities"
                            content="You agree not to use Grafty to transmit any content that is illegal, harmful, threatening, abusive, harassing, defamatory, vulgar, obscene, or otherwise objectionable. Meta prohibits certain business categories (e.g., gambling, adult content, illicit drugs) from using the WhatsApp Business API. Violation of these restrictions will result in immediate termination of your access."
                        />
                        <TermSection
                            title="5. Intellectual Property"
                            content="All content, features, and functionality on the Grafty platform, including but not limited to software, designs, and logos, are the exclusive property of Grekam. Using Grafty does not grant you ownership of any intellectual property rights in our services or the content you access."
                        />
                        <TermSection
                        ...
                        <TermSection
                            ...
                            content="Grafty shall not be liable for any indirect, incidental, special, or consequential damages resulting from the use or inability to use the service, including service interruptions caused by Meta's infrastructure or API changes. Our total liability shall not exceed the amount paid by you for the service in the preceding three months."
                        />
                        <TermSection
                            title="8. Termination"
                        ...
                        <TermSection
                            ...
                            content="For any legal inquiries or support regarding these terms, please contact us at support@grafty.pro."
                        />
                    </div>
                </div>
            </section>
