...
async function main() {
    ...
    await prisma.subscriptionPlan.upsert({
        ...
        create: {
            ...
            yearly_price: 19999, // ~2 Months Free
            min_reseller_monthly_price: 999,  // 50% Margin Floor
            min_reseller_yearly_price: 9999,   // 50% Margin Floor
            currency: "INR",
            max_users: 2,
            max_contacts: 10000,
            max_flows: 10,
    ...
    await prisma.subscriptionPlan.upsert({
        ...
        create: {
            ...
            yearly_price: 39999, // ~2 Months Free
            min_reseller_monthly_price: 1999, // 50% Margin Floor
            min_reseller_yearly_price: 19999,  // 50% Margin Floor
            currency: "INR",
            max_users: 10,
            max_contacts: 50000,
            max_flows: 50,
