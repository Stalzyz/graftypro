...
HASH=$(ssh -o StrictHostKeyChecking=no $VPS "docker exec grafty_bsp-web-1 node -e \"
...
ssh -o StrictHostKeyChecking=no $VPS "docker exec grafty_bsp-postgres-1 psql -U grafty -d grafty_bsp -c \"
UPDATE \\\"AdminUser\\\" 
