    ...
    static async getBrandingForWorkspace(workspaceId?: string, hostname?: string) {
        ...
        try {
            ...
            return {
                ...
                brand_name: config?.platform_name?.trim() || "Grafty",
                logo_url: getAbsoluteMediaUrl(config?.logo_url || "/grafty_brand.svg"),
                dark_logo_url: getAbsoluteMediaUrl(config?.dark_logo_url || "/grafty_brand.svg"),
                favicon_url: getAbsoluteMediaUrl(config?.favicon_url || "/favicon.ico"),
                login_logo_url: getAbsoluteMediaUrl(config?.login_logo_url || config?.logo_url || "/grafty_brand.svg"),
                dashboard_logo_url: getAbsoluteMediaUrl(config?.dashboard_logo_url || config?.logo_url || "/grafty_brand.svg"),
                reseller_logo_url: getAbsoluteMediaUrl(config?.reseller_logo_url || config?.logo_url || "/grafty_brand.svg"),
                partner_logo_url: getAbsoluteMediaUrl(config?.partner_logo_url || config?.logo_url || "/grafty_brand.svg"),
                footer_logo_url: getAbsoluteMediaUrl(config?.footer_logo_url || config?.logo_url || "/grafty_brand.svg"),
            ...
            return {
                is_white_labeled: false,
                brand_name: "Grafty",
                logo_url: "/grafty_brand.svg",
                dark_logo_url: "/grafty_brand.svg",
